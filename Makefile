...
build:
	go build -buildmode=plugin -o actions/plugins/noop.so actions/plugins/noop.go
	go build -buildmode=plugin -o actions/plugins/clickhouse.so actions/plugins/clickhouse.go
	go build
